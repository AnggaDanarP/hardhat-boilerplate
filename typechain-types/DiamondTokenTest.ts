...
export interface DiamondTokenTestInterface extends Interface {
...
export interface DiamondTokenTest extends BaseContract {
  connect(runner?: ContractRunner | null): DiamondTokenTest;
  waitForDeployment(): Promise<this>;

  interface: DiamondTokenTestInterface;
